...
function PricingCardDaisyUi({pricing}) {
    const {name, price, features, popular} = pricing;
  return (
   <div className="card w-96 bg-base-100 shadow-sm">
  <div className="card-body">
    {
      popular &&  <span className="badge badge-l badge-warning text-blue-600">Most Popular</span>
    }
...
export default PricingCardDaisyUi